...
const Storyview = () => {
    ...
    const getData =()=>{
        http.get(`/catalog/complex/history/?name=${name}&square_min=${squeremin}&square_max=${squeremax}&price_min=${pricemin}&price_max=${pricemax}&deadline=${sana}&property_type=${protery}&development_type=${development}&construction_phase=${constraction}&transaction_type=${uslovi}&otdelka=${otdelka}&comnat=${comnat}&coutry=`).then((res)=>{
