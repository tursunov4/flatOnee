        ...
        <div className="container__main">
          <ul className="ourmis__about-list">
            ...
            }
            {
              ...
              <p>
              {
              lan === "ru" && `«Нейроброкер» Flat one упрощает все действия в недвижимости: от покупки и сдачи до оплаты коммунальных услуг за счёт связки из нескольких нейросетей в единой системе.`
            }
            {
            ...
            }
            {
            ...
            }    
             {
              ...
              <p>
              {
              lan === "ru" && ` Автоматический анализ финансовых рисков и возможностей при покупке недвижимости помогает клиентам принять обоснованное решение, сократив время на анализ рисков и инвестиций`
            }
            {
            ...
            }   
            {
              ...
              <p>
              {
              lan === "ru" && `Искусственный интеллект в продаже недвижимости прогнозирует для вас спрос и сообщает о любых изменениях на рынке, что помогает принять лучшее решение`
            }
            {
            ...
            }
            {
              ...
              <div data-aos-duration="1200"   data-aos="fade-down" className="main-cont__wrap-inner">
                ...
                <ul className="main-cont__wrap-inner-text">
                  <li>
                    ...
                    <h5>
                    {
                    lan === "ru" && "Инвестору в недвижимость"
                 }
                {
              ...
              lan === "zh" && "房地產投資者"
                  ...
                  <li>
                    ...
                    <h5>
                    {
                    lan === "ru" && "Собственнику, сдающему долгосрочно"
                 }
                {
        ...
        <div className="container__main">
          <div className="offer-section__mwrap">
            ...
            <div data-aos-duration="1200"  data-aos="fade-down" className="offer-section__bar2">
              ...
              <p>
              {
                    lan === "ru" &&  `Мы экономим не только своё, но и ваше время и для нас важно не просто презентовать все различные предложения, а находить именно то, что вы давно искали, при этом не тратя время на не актуальные или фейковые лоты рынка.`
                 }
                {
          ...
          <ul className="apartament-list">
            ...
            dataOffices?.map((item , index) =>(
              ...
              <div className="apartament-list__header">
                <div>
                  <p onClick={()=>entersitProduct(item.id)} className="apartament-list__address">
                     {item.name}
                  </p>
