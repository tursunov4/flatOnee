         ...
         <div onClick={()=>setTypelan(!typelan)} id="choose__language" className="choose__language">
          ...
          <img id="strelka" className={typelan ? "strelkarotate" : ""} src={strelka} alt="strelka"/>
            ...
            <li className='list__choose'>
             ...
             <li className='list__choose' >
              <div>
                <img  width="26" src={zhn} alt="flag"/>
                 <p >China</p>
              </div>
              <input checked={lan ==="zh" ? true : false} onClick={()=>handleLangClick("zh")}  id='nam' name='lan'  className="choose__language-input"  type="checkbox"/>
            </li>
         </ul>
            </form>
